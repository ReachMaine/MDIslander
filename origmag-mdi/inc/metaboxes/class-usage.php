...
------------
mod's (default Post thumbnail to 'Disabled') by switching order in metabox array.
*/
...
if (is_admin()){
  ...
  $p_config = array(
	...
	$p_meta->addSelect($prefix.'post_thumb',array('Disable' => 'Disable','Enable'=>'Enable'),array('name'=> 'Post Thumbnail', 'desc'=>'Enable/Disable Post Thumbnail in Single post'));
