			...
			<?php
			 	if (($p < 4) && (get_the_ID() != $featuredid))  { ?>
					<li style="list-style-type:none">
						...
						<h4 class="prl-article-title"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title();?></a> <?php echo get_label_format(get_the_ID());?> <?php echo get_label_meta(get_the_ID());?></h4>
					</li>
			 <?php $p++;  } ?>
	        <?php
	        	if ($p == 4) {
