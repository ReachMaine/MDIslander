...
<?php
	...
	function block($instance) {
		...
		<div class="prl-grid prl-grid-divider">
			...
			$tag_posts = new WP_Query(array('post_type' => array('post','obituary'),'showposts' => $post_count, 'post__not_in' => get_option('sticky_posts'),'tag__in' => $tagg,'orderby' => 'date', 'no_found_rows' => TRUE ));
